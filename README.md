...
🎓 University Programming Technician graduated from the  
...
### 🛒 Shoppify
E-commerce web platform built with Angular + SpringBoot + PostgreSQL.

### 📦 Stockify
REST API for managing products, providers, and points of sale.  
